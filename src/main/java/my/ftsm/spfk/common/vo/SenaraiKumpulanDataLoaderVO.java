...
@Data
public class SenaraiKumpulanDataLoaderVO {
	...
	public static SenaraiKumpulanDataLoaderVO fromCell(Row row) {
		SenaraiKumpulanDataLoaderVO result = new SenaraiKumpulanDataLoaderVO();
    ...
    public String toString() {
        return kod + "\t" + nama + "\t" + perihal  + "\t" + parents + "\t" + aktif + "\t" + nilaiStr;
    }
